...
//                     <p className="mt-2 text-gray-600">Stay informed about children's rights and resources</p>
...
//                 {/* Legal Section */}
//                 <div className="mt-10 text-center text-gray-600 border-t border-gray-300 pt-6">
